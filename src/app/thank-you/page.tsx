  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white flex items-center justify-center px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <a
          href="https://wa.me/17784045267?text=Hi! I just submitted a quote request. Here are the photos:"
          target="_blank"
        ...
        <p className="text-neutral-600 text-sm">
          Or call/text us directly: <a href="tel:+17784045267" className="text-emerald-400 hover:text-emerald-300">(778) 404-5267</a>
        </p>
