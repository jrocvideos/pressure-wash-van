        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              { img: "/images/car-ba.png", title: "Car & Vehicle Detailing", sub: "Barn find to showroom shine.", accent: "#ef4444" },
              { img: "/images/boat-ba.png", title: "Boat & Marine", sub: "Hull, deck, upholstery — like new.", accent: "#3b82f6" },
            ].map((card) => (
